class ProductInfo extends HTMLElement {
  ...
  constructor() {
    ...
    this.tabs= this.informationTabs.querySelectorAll('tab');
    console.log(this.tabs);
    this.tabsContent= this.informationTabs.querySelectorAll('info-tab-content');
    this.tabs.forEach((tab, index) => tab.addEventListener('click', this.onInformationTabEvent(index).bind(this)));
  ...
  get informationTabs(){
    return this.querySelector('information-tabs');
  }
  ...
  onInformationTabEvent(tabIndex){
      this.tabs.forEach((tab) => tab.classList.remove('collections-tab_active'));
      this.tabsContent.forEach((content) => content.classList.remove('active'));

      this.tabs[tabIndex].classList.add('collections-tab_active');
      this.tabsContent[tabIndex].classList.add('active');
